...
PROC TABULATE 
	...
	VAR TOTALAPPS PREAPPROVED_FLAG BOOKED TILA_LnAmt;
	TABLES APPSTATE ALL, 
...
PROC TABULATE 
	...
	TABLES APPSTATE ALL, 
		   ...
		   TILA_LnAmt = "$ Booked" * F = dollar18.0 
		   TILA_LnAmt * MEAN = "avg adv" * F = dollar18.0
			/ NOCELLMERGE;
...
PROC TABULATE 
	...
	TABLES BOOKED_MONTH * SUPERVISOR ALL, 
		BOOKED = "BOOKED" * F = comma18.0 
		TILA_LnAmt = "$ BOOKED" * F = dollar18.0 
		TILA_LnAmt * MEAN = "avg adv" * F = dollar18.0/NOCELLMERGE;
	BY VP;
	WHERE SOURCE = 'Web Apps' & BOOKED_MONTH = &BOOK_MONTH & ENTYRMONTH = &APPYRMONTH;
RUN;
...
PROC TABULATE 
	...
	TABLES AMTBUCKET ALL, 
		...
		TILA_LnAmt = "$ BOOKED" * F = dollar18.0 
		TILA_LnAmt * MEAN = "avg adv" * F = dollar18.0 
		TILA_LnAmt * min = "Bk Min $" * F = dollar18.0 
		TILA_LnAmt * max = "Bk Max $" * F = dollar18.0/NOCELLMERGE;
	WHERE SOURCE = 'Web Apps' & BOOKED_MONTH = &BOOK_MONTH & ENTYRMONTH = &APPYRMONTH;
RUN;
