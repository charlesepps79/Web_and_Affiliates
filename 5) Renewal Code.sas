...
%LET LOAN_ENTDATE_END1 = "2020-03-31"; /* CHANGE TO END OF THE MONTH */
...
PROC SQL;
	...
	SELECT * FROM ALL_LEADS_3 WHERE ENTYRMONTH IN (202003); /* CHANGE */
QUIT;
...
PROC SQL;
	SELECT ENTYRMONTH, 
		   SUM(BOOKED) 
	FROM MONTH_BOOK 
	WHERE LEADYRMONTH IN (202003) GROUP BY 1; /* CHANGE */
QUIT;
