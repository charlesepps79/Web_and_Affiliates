...
%LET LOAN_ENTDATE_END1 = "2019-07-31"; /* CHANGE TO END OF THE MONTH */
...
PROC SQL;
	...
	SELECT * FROM ALL_APPS_3 WHERE ENTYRMONTH IN (201907); /* CHANGE */
QUIT;
...
PROC SQL;
	SELECT ENTYRMONTH, 
		   SUM(BOOKED) 
	FROM MONTH_BOOK 
	WHERE APPYRMONTH IN (201907) GROUP BY 1; /* CHANGE */
QUIT;
