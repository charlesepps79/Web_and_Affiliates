...
%LET LOAN_ENTDATE_END1 = "2020-04-30"; /* CHANGE TO END OF THE MONTH */
...
PROC SQL;
	...
	SELECT * FROM ALL_LEADS_3 WHERE ENTYRMONTH IN (202004); /* CHANGE */
QUIT;
...
PROC SQL;
	SELECT ENTYRMONTH, 
		   SUM(BOOKED) 
	FROM MONTH_BOOK 
	WHERE LEADYRMONTH IN (202004) GROUP BY 1; /* CHANGE */
QUIT;
