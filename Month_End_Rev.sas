...
data _null_;
	call symput("importfile",
		"WORK.final_set_20210301");
run;

PROC SQL;
   CREATE TABLE WORK.LEADS AS
   SELECT *
      FROM WORK.final_set_20210301 t1;
QUIT;
...
PROC SQL;
	   ...
	   *** Generate BY_DISTRICT reports ----------------------------------- ***;
       ...
       proc export
       	data = LT_BY_BRANCH
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2021\February_2021_Web_Reports\Affiliates_by_Branch_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "Lending_Tree";
       run;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2021\February_2021_Web_Reports\Lending_Tree_by_Routing_ID_and_Amount_Bucket_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "Lending_Tree";
       run;
       ...
       proc export
      	...
      	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2021\February_2021_Web_Reports\Affiliates_by_State_and_Amount_Bucket_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "Lending_Tree";
       run;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2021\February_2021_Web_Reports\Affiliates_by_Application_Address_Ownership_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "Lending_Tree";
       run;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2021\February_2021_Web_Reports\Affiliates_by_Request_Purpose_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "Lending_Tree";
       run;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2021\February_2021_Web_Reports\Affiliates_by_Amount_Bucket_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "LendingTree";
       run;
       ...
       proc export
       	data = ALL_BY_SOURCE
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2021\February_2021_Web_Reports\All_Affiliates_by_Source_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "All Sources";
       run;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2021\February_2021_Web_Reports\All_Affiliates_by_UTM_Campaign_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "UTM_Campaign";
       run;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2021\February_2021_Web_Reports\Affiliates_by_Source_State_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "LendingTree";
       run;
       ...
       proc export
       	data = LT_BY_DISTRICT
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2021\February_2021_Web_Reports\Affiliates_by_District_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "LendingTree";
       run;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2021\February_2021_Web_Reports\Affiliates_by_Decision_Status_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "LendingTree";
       run;
