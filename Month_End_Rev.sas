...
data _null_;
	call symput("importfile",
		"WORK.final_set_restate_202002");
run;

PROC SQL;
   CREATE TABLE WORK.LEADS AS
   SELECT *
      FROM WORK.final_set_restate_202002 t1;
QUIT;
...
QUIT;
       ...
       *** Generate BY_DISTRICT reports ----------------------------------- ***;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2020\February_2020_Web_Reports\All_Affiliates_by_UTM_Campaign_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "UTM_Campaign";
       run;
