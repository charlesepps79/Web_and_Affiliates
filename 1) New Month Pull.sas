...
%LET MAIN_DIR = 
	\\mktg-app01\E\cepps\Web_Report\Reports\07_2018;
...
%LET LOAN_ENT_DATE_BEGIN = "2018-07-01";
*** CHANGE DATE TO END OF APP MONTH ------------------------------ ***;
%LET LOAN_ENT_DATE_END = "2018-07-31";


*** NO CHANGE - ENSURE CURRENT MONTH APP FILE -------------------- ***;
%LET AIP_REPORT_LOC = 
"\\mktg-app01\E\cepps\Web_Report\Reports\07_2018\Application Internet Report 2018-07-01 to 2018-07-31.xlsx";
%LET TAB_NAME = Application Internet Report;

*** CHANGE TO LAST MONTH ALL APPS FILENAME ----------------------- ***;
%LET ALL_APPS_HIST_LOC = "&MAIN_DIR\ALL_APPS_JUN2018.xlsx";

*** THIS IS FILE NAME OF CURRENT ALL APPS FILE ------------------- ***;
%LET ALL_APPS_2_EXPORT = ALL_APPS_JUL_2018;
%LET VW_L_EXPORT = VW_L_JUL_2018; /* THIS IS FILENAME OF VW_L FILE */
...
%LET RECENT_MONTH_NO = 201807; /* YYYYMM CHANGE TO APP MONTH */
%LET ONE_MO_AGO = 201806; /* YYYYMM CHANGE TO APP MONTH - 1 */
%LET TWO_MO_AGO = 201805;	/* YYYYMM CHANGE TO APP MONTH - 2 */
