...
%LET MAIN_DIR = 
	\\mktg-app01\E\cepps\Web_Report\Reports\08_2019;
...
%LET LOAN_ENT_DATE_BEGIN = "2019-08-01";
*** CHANGE DATE TO END OF APP MONTH ------------------------------ ***;
%LET LOAN_ENT_DATE_END = "2019-08-31";


*** NO CHANGE - ENSURE CURRENT MONTH APP FILE -------------------- ***;
%LET AIP_REPORT_LOC = 
"\\mktg-app01\E\cepps\Web_Report\Reports\08_2019\Application Internet report 2019 August.xlsx";
%LET TAB_NAME = Application Internet Report;

*** CHANGE TO LAST MONTH ALL APPS FILENAME ----------------------- ***;
%LET ALL_APPS_HIST_LOC = "&MAIN_DIR\ALL_APPS_JUL2019.xlsx";

*** THIS IS FILE NAME OF CURRENT ALL APPS FILE ------------------- ***;
%LET ALL_APPS_2_EXPORT = ALL_APPS_AUG_2019;
...
%LET RECENT_MONTH_NO = 201908; /* YYYYMM CHANGE TO APP MONTH */
%LET ONE_MO_AGO = 201907; /* YYYYMM CHANGE TO APP MONTH - 1 */
%LET TWO_MO_AGO = 201906;	/* YYYYMM CHANGE TO APP MONTH - 2 */
