...
%LET MAIN_DIR = 
	\\mktg-app01\E\cepps\Web_Report\Reports\07_2019;
...
%LET NEW_MONTH_FILE = JUL_APPS;
*** CHANGE DATE TO START OF APP MONTH ---------------------------- ***;
%LET LOAN_ENT_DATE_BEGIN = "2019-07-01";
*** CHANGE DATE TO END OF APP MONTH ------------------------------ ***;
%LET LOAN_ENT_DATE_END = "2019-07-31";


*** NO CHANGE - ENSURE CURRENT MONTH APP FILE -------------------- ***;
%LET AIP_REPORT_LOC = 
"\\mktg-app01\E\cepps\Web_Report\Reports\07_2019\Application Internet Report 2019 July.xlsx";
%LET TAB_NAME = Application Internet Report;

*** CHANGE TO LAST MONTH ALL APPS FILENAME ----------------------- ***;
%LET ALL_APPS_HIST_LOC = "&MAIN_DIR\ALL_APPS_JUN2019.xlsx";

*** THIS IS FILE NAME OF CURRENT ALL APPS FILE ------------------- ***;
%LET ALL_APPS_2_EXPORT = ALL_APPS_JUL_2019;
...
%LET ALL_APPS_FILE = ALL_APPS_JUN_FINAL;
*** CHANGE MONTH NAME TO APP MONTH - 1 MONTH --------------------- ***;
%LET ALL_APPS_FILE_2 = ALL_APPS_JUN_FINAL;

%LET RECENT_MONTH_NO = 201907; /* YYYYMM CHANGE TO APP MONTH */
%LET ONE_MO_AGO = 201906; /* YYYYMM CHANGE TO APP MONTH - 1 */
%LET TWO_MO_AGO = 201905;	/* YYYYMM CHANGE TO APP MONTH - 2 */

*** CHANGE MONTH NAME TO APP MONTH - 2 MONTH --------------------- ***;
%LET TWO_MO_BOOKED = MAY_APPS_B;
%LET TWO_MO_UNBOOKED = MAY_APPS_UNB;
%LET APPS_MINUS_2_MO_AGO = APPS_EXCEPT_MAY;

*** CHANGE MONTH NAME TO APP MONTH - 1 MONTH --------------------- ***;
%LET ONE_MO_BOOKED = JUN_APPS_B;
%LET ONE_MO_UNBOOKED = JUN_APPS_UNB;
%LET APPS_MINUS_1_MO_AGO = APPS_EXCEPT_JUN;
