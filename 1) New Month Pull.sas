...
%LET MAIN_DIR = 
	\\mktg-app01\E\cepps\Web_Report\Reports\05_2019;
...
%LET LOAN_ENT_DATE_BEGIN = "2019-05-01";
*** CHANGE DATE TO END OF APP MONTH ------------------------------ ***;
%LET LOAN_ENT_DATE_END = "2019-05-31";


*** NO CHANGE - ENSURE CURRENT MONTH APP FILE -------------------- ***;
%LET AIP_REPORT_LOC = 
"\\mktg-app01\E\cepps\Web_Report\Reports\05_2019\application Internet Report May 2019.xlsx";
%LET TAB_NAME = Application Internet Report;

*** CHANGE TO LAST MONTH ALL APPS FILENAME ----------------------- ***;
%LET ALL_APPS_HIST_LOC = "&MAIN_DIR\ALL_APPS_APR2019.xlsx";

*** THIS IS FILE NAME OF CURRENT ALL APPS FILE ------------------- ***;
%LET ALL_APPS_2_EXPORT = ALL_APPS_MAY_2019;
%LET VW_L_EXPORT = VW_L_MAY_2019; /* THIS IS FILENAME OF VW_L FILE */

%LET APP_IMPORT_FILE = APP_IMPORT_FILE_2; 
*** CHANGE MONTH NAME TO APP MONTH - 1 MONTH --------------------- ***;
%LET ALL_APPS_FILE = ALL_APPS_APR_FINAL;
*** CHANGE MONTH NAME TO APP MONTH - 1 MONTH --------------------- ***;
%LET ALL_APPS_FILE_2 = ALL_APPS_APR_FINAL;

%LET RECENT_MONTH_NO = 201905; /* YYYYMM CHANGE TO APP MONTH */
%LET ONE_MO_AGO = 201904; /* YYYYMM CHANGE TO APP MONTH - 1 */
%LET TWO_MO_AGO = 201903;	/* YYYYMM CHANGE TO APP MONTH - 2 */

*** CHANGE MONTH NAME TO APP MONTH - 2 MONTH --------------------- ***;
%LET TWO_MO_BOOKED = MAR_APPS_B;
%LET TWO_MO_UNBOOKED = MAR_APPS_UNB;
%LET APPS_MINUS_2_MO_AGO = APPS_EXCEPT_MAR;

*** CHANGE MONTH NAME TO APP MONTH - 1 MONTH --------------------- ***;
%LET ONE_MO_BOOKED = APR_APPS_B;
%LET ONE_MO_UNBOOKED = APR_APPS_UNB;
%LET APPS_MINUS_1_MO_AGO = APPS_EXCEPT_APR;
