...
%LET MAIN_DIR = 
	\\mktg-app01\E\cepps\Web_Report\Reports\12_2019;
...
%LET LOAN_ENT_DATE_BEGIN = "2019-12-01";
*** CHANGE DATE TO END OF APP MONTH ------------------------------ ***;
%LET LOAN_ENT_DATE_END = "2019-12-31";


*** NO CHANGE - ENSURE CURRENT MONTH APP FILE -------------------- ***;
%LET AIP_REPORT_LOC = 
"\\mktg-app01\E\cepps\Web_Report\Reports\12_2019\Application Internet Report Dec 2019.xlsx";
%LET TAB_NAME = Application Internet Report;

*** CHANGE TO LAST MONTH ALL APPS FILENAME ----------------------- ***;
%LET ALL_APPS_HIST_LOC = "&MAIN_DIR\ALL_APPS_NOV2019.xlsx";
...
%LET ALL_APPS_FILE = ALL_APPS_ONE_MONTH_FINAL;
*** CHANGE MONTH NAME TO APP MONTH - 1 MONTH --------------------- ***;
%LET ALL_APPS_FILE_2 = ALL_APPS_ONE_MONTH_FINAL;

%LET RECENT_MONTH_NO = 201912; /* YYYYMM CHANGE TO APP MONTH */
%LET ONE_MO_AGO = 201911; /* YYYYMM CHANGE TO APP MONTH - 1 */
%LET TWO_MO_AGO = 201910;	/* YYYYMM CHANGE TO APP MONTH - 2 */

*** CHANGE MONTH NAME TO APP MONTH - 2 MONTH --------------------- ***;
%LET TWO_MO_BOOKED = TWO_MONTH_APPS_B;
%LET TWO_MO_UNBOOKED = TWO_MONTH_APPS_UNB;
%LET APPS_MINUS_2_MO_AGO = APPS_EXCEPT_TWO_MONTH;

*** CHANGE MONTH NAME TO APP MONTH - 1 MONTH --------------------- ***;
%LET ONE_MO_BOOKED = ONE_MONTH_APPS_B;
%LET ONE_MO_UNBOOKED = ONE_MONTH_APPS_UNB;
%LET APPS_MINUS_1_MO_AGO = APPS_EXCEPT_ONE_MONTH;
