...
%LET MAIN_DIR = 
	\\mktg-app01\E\cepps\Web_Report\Reports\09_2018;
...
%LET LOAN_ENT_DATE_BEGIN = "2018-09-01";
*** CHANGE DATE TO END OF APP MONTH ------------------------------ ***;
%LET LOAN_ENT_DATE_END = "2018-09-30";


*** NO CHANGE - ENSURE CURRENT MONTH APP FILE -------------------- ***;
%LET AIP_REPORT_LOC = 
"\\mktg-app01\E\cepps\Web_Report\Reports\09_2018\Application Internet Report 2018-09-01 to 2018-09-30.xlsx";
%LET TAB_NAME = Application Internet Report;

*** CHANGE TO LAST MONTH ALL APPS FILENAME ----------------------- ***;
%LET ALL_APPS_HIST_LOC = "&MAIN_DIR\ALL_APPS_AUG2018.xlsx";

*** THIS IS FILE NAME OF CURRENT ALL APPS FILE ------------------- ***;
%LET ALL_APPS_2_EXPORT = ALL_APPS_SEP_2018;
%LET VW_L_EXPORT = VW_L_SEP_2018; /* THIS IS FILENAME OF VW_L FILE */
...
%LET RECENT_MONTH_NO = 201809; /* YYYYMM CHANGE TO APP MONTH */
%LET ONE_MO_AGO = 201808; /* YYYYMM CHANGE TO APP MONTH - 1 */
%LET TWO_MO_AGO = 201807;	/* YYYYMM CHANGE TO APP MONTH - 2 */
