...
%LET NEW_MONTH_FILE_2 = DEC_APPS_2;
/*
%LET APP_IMPORT_FILE = &ALL_APPS_2.; 
*/
%LET RECENT_MONTH_NO = 201812;
%LET ONE_MO_AGO = 201811;
%LET TWO_MO_AGO = 201810;
%LET TWO_MO_AGO_APPS = OCT_APPS;
%LET TWO_MO_AGO_APPS_NEW = OCT_APPS_NEW;
%LET TWO_MO_BOOKED_2 = BOOKED_OCT;
%LET TWO_MO_UNBOOKED_2 = UNBOOKED_OCT;
%LET ONE_MO_BOOKED_2 = NOV_APPS_B_2;
%LET ONE_MO_UNBOOKED_2 = NOV_APPS_UNB_2;
%LET ALL_APPS_FILE_2 = ALL_APPS_NOV_FINAL;
%LET ONE_MO_AGO_APPS = NOV_APPS;
%LET ONE_MO_AGO_APPS_NEW = NOV_APPS_NEW;
%LET ONE_MO_AGO_APPS_2 = NOV_APPS_2;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_DEC2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_DEC2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_DEC2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
