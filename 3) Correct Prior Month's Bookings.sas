...
*/
%LET RECENT_MONTH_NO = 202002;
%LET ONE_MO_AGO = 202001;
%LET TWO_MO_AGO = 201912;
...
PROC EXPORT 
	DATA = ALL_LEADS_3 
	OUTFILE = "&MAIN_DIR\ALL_LEADS_FEB2020.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_FEB2020.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_FEB2020.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
