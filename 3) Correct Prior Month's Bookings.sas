...
*/
%LET RECENT_MONTH_NO = 201911;
%LET ONE_MO_AGO = 201910;
%LET TWO_MO_AGO = 201909;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_NOV2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_NOV2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_NOV2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
