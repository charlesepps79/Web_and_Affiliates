...
*/
%LET RECENT_MONTH_NO = 201809;
%LET ONE_MO_AGO = 201808;
%LET TWO_MO_AGO = 201807;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_SEP2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_SEP2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_SEP2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
