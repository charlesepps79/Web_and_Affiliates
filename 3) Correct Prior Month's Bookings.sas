...
%LET NEW_MONTH_FILE_2 = OCT_APPS_2;
/*
%LET APP_IMPORT_FILE = &ALL_APPS_2.; 
*/
%LET RECENT_MONTH_NO = 201810;
%LET ONE_MO_AGO = 201809;
%LET TWO_MO_AGO = 201808;
%LET TWO_MO_AGO_APPS = AUG_APPS;
%LET TWO_MO_AGO_APPS_NEW = AUG_APPS_NEW;
%LET TWO_MO_BOOKED_2 = BOOKED_AUG;
%LET TWO_MO_UNBOOKED_2 = UNBOOKED_AUG;
%LET ONE_MO_BOOKED_2 = SEP_APPS_B_2;
%LET ONE_MO_UNBOOKED_2 = SEP_APPS_UNB_2;
%LET ALL_APPS_FILE_2 = ALL_APPS_SEP_FINAL;
%LET ONE_MO_AGO_APPS = SEP_APPS;
%LET ONE_MO_AGO_APPS_NEW = SEP_APPS_NEW;
%LET ONE_MO_AGO_APPS_2 = SEP_APPS_2;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_OCT2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_OCT2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_OCT2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
