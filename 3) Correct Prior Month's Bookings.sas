...
%LET NEW_MONTH_FILE_2 = NOV_APPS_2;
/*
%LET APP_IMPORT_FILE = &ALL_APPS_2.; 
*/
%LET RECENT_MONTH_NO = 201811;
%LET ONE_MO_AGO = 201810;
%LET TWO_MO_AGO = 201809;
%LET TWO_MO_AGO_APPS = SEP_APPS;
%LET TWO_MO_AGO_APPS_NEW = SEP_APPS_NEW;
%LET TWO_MO_BOOKED_2 = BOOKED_SEP;
%LET TWO_MO_UNBOOKED_2 = UNBOOKED_SEP;
%LET ONE_MO_BOOKED_2 = OCT_APPS_B_2;
%LET ONE_MO_UNBOOKED_2 = OCT_APPS_UNB_2;
%LET ALL_APPS_FILE_2 = ALL_APPS_OCT_FINAL;
%LET ONE_MO_AGO_APPS = OCT_APPS;
%LET ONE_MO_AGO_APPS_NEW = OCT_APPS_NEW;
%LET ONE_MO_AGO_APPS_2 = OCT_APPS_2;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_NOV2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_NOV2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_NOV2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
