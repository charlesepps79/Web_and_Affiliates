...
%LET NEW_MONTH_FILE_2 = CURRENT_APPS_2;
/*
%LET APP_IMPORT_FILE = &ALL_APPS_2.; 
*/
%LET RECENT_MONTH_NO = 201910;
%LET ONE_MO_AGO = 201909;
%LET TWO_MO_AGO = 201908;
%LET TWO_MO_AGO_APPS = TWO_MONTH_APPS;
%LET TWO_MO_AGO_APPS_NEW = TWO_MONTH_APPS_NEW;
%LET TWO_MO_BOOKED_2 = BOOKED_TWO_MONTH;
%LET TWO_MO_UNBOOKED_2 = UNBOOKED_TWO_MONTH;
%LET ONE_MO_BOOKED_2 = ONE_MONTH_APPS_B_2;
%LET ONE_MO_UNBOOKED_2 = ONE_MONTH_APPS_UNB_2;
%LET ALL_APPS_FILE_2 = ALL_APPS_ONE_MONTH_FINAL;
%LET ONE_MO_AGO_APPS = ONE_MONTH_APPS;
%LET ONE_MO_AGO_APPS_NEW = ONE_MONTH_APPS_NEW;
%LET ONE_MO_AGO_APPS_2 = ONE_MONTH_APPS_2;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_OCT2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_OCT2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_OCT02019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
