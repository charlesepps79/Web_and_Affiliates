...
*/
%LET RECENT_MONTH_NO = 201907;
%LET ONE_MO_AGO = 201906;
%LET TWO_MO_AGO = 201905;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_JUL2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_JUL2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_JUL2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
