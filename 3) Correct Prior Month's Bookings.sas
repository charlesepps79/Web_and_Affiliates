...
%LET NEW_MONTH_FILE_2 = JUN_APPS_2;
/*
%LET APP_IMPORT_FILE = &ALL_APPS_2.; 
*/
%LET RECENT_MONTH_NO = 201906;
%LET ONE_MO_AGO = 201905;
%LET TWO_MO_AGO = 201904;
%LET TWO_MO_AGO_APPS = APR_APPS;
%LET TWO_MO_AGO_APPS_NEW = APR_APPS_NEW;
%LET TWO_MO_BOOKED_2 = BOOKED_APR;
%LET TWO_MO_UNBOOKED_2 = UNBOOKED_APR;
%LET ONE_MO_BOOKED_2 = MAY_APPS_B_2;
%LET ONE_MO_UNBOOKED_2 = MAY_APPS_UNB_2;
%LET ALL_APPS_FILE_2 = ALL_APPS_MAY_FINAL;
%LET ONE_MO_AGO_APPS = MAY_APPS;
%LET ONE_MO_AGO_APPS_NEW = MAY_APPS_NEW;
%LET ONE_MO_AGO_APPS_2 = MAY_APPS_2;
...
DATA ALL_APPS_2;
	...
	KEEP BRACCTNO CLASSID CLASSCODE	CLASSTRANSLATION OWNST SRCD	POCD
		 ...
		 TILA_LnAmt FICO_25PT_APP CELLPHONE APPNUMBER PORTALAPPID
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_JUN2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
DATA CANOPYLOAD;
	SET CANOPYFINAL;
	KEEP PORTALAPPID TILA_LnAmt EFFRATE APRATE ORGTERM ENTDATE
		 APPDATE_SAS BRACCTNO;
RUN;

PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_JUN2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_JUN2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
