...
%LET NEW_MONTH_FILE_2 = JUL_APPS_2;
/*
%LET APP_IMPORT_FILE = &ALL_APPS_2.; 
*/
%LET RECENT_MONTH_NO = 201807;
%LET ONE_MO_AGO = 201806;
%LET TWO_MO_AGO = 201805;
%LET TWO_MO_AGO_APPS = MAY_APPS;
%LET TWO_MO_AGO_APPS_NEW = MAY_APPS_NEW;
%LET TWO_MO_BOOKED_2 = BOOKED_MAY;
%LET TWO_MO_UNBOOKED_2 = UNBOOKED_MAY;
%LET ONE_MO_BOOKED_2 = JUN_APPS_B_2;
%LET ONE_MO_UNBOOKED_2 = JUN_APPS_UNB_2;
%LET ALL_APPS_FILE_2 = ALL_APPS_JUN_FINAL;
%LET ONE_MO_AGO_APPS = JUN_APPS;
%LET ONE_MO_AGO_APPS_NEW = JUN_APPS_NEW;
%LET ONE_MO_AGO_APPS_2 = JUN_APPS_2;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_JUL2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_JUL2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_JUL2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
