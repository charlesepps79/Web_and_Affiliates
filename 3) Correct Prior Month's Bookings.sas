...
%LET NEW_MONTH_FILE_2 = JAN_APPS_2;
/*
%LET APP_IMPORT_FILE = &ALL_APPS_2.; 
*/
%LET RECENT_MONTH_NO = 201901;
%LET ONE_MO_AGO = 201812;
%LET TWO_MO_AGO = 201811;
%LET TWO_MO_AGO_APPS = NOV_APPS;
%LET TWO_MO_AGO_APPS_NEW = NOV_APPS_NEW;
%LET TWO_MO_BOOKED_2 = BOOKED_NOV;
%LET TWO_MO_UNBOOKED_2 = UNBOOKED_NOV;
%LET ONE_MO_BOOKED_2 = DEC_APPS_B_2;
%LET ONE_MO_UNBOOKED_2 = DEC_APPS_UNB_2;
%LET ALL_APPS_FILE_2 = ALL_APPS_DEC_FINAL;
%LET ONE_MO_AGO_APPS = DEC_APPS;
%LET ONE_MO_AGO_APPS_NEW = DEC_APPS_NEW;
%LET ONE_MO_AGO_APPS_2 = DEC_APPS_2;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_JAN2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_JAN2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_JAN2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
