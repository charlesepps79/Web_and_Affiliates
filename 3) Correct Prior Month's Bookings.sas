...
*/
%LET RECENT_MONTH_NO = 201905;
%LET ONE_MO_AGO = 201904;
%LET TWO_MO_AGO = 201903;
%LET TWO_MO_AGO_APPS = MAR_APPS;
%LET TWO_MO_AGO_APPS_NEW = MAR_APPS_NEW;
%LET TWO_MO_BOOKED_2 = BOOKED_MAR;
%LET TWO_MO_UNBOOKED_2 = UNBOOKED_MAR;
%LET ONE_MO_BOOKED_2 = APR_APPS_B_2;
%LET ONE_MO_UNBOOKED_2 = APR_APPS_UNB_2;
%LET ALL_APPS_FILE_2 = ALL_APPS_APR_FINAL;
%LET ONE_MO_AGO_APPS = APR_APPS;
%LET ONE_MO_AGO_APPS_NEW = APR_APPS_NEW;
%LET ONE_MO_AGO_APPS_2 = APR_APPS_2;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_MAY2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_MAY2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_MAY2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
