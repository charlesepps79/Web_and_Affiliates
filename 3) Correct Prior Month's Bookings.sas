...
%LET NEW_MONTH_FILE_2 = AUG_APPS_2;
/*
%LET APP_IMPORT_FILE = &ALL_APPS_2.; 
*/
%LET RECENT_MONTH_NO = 201908;
%LET ONE_MO_AGO = 201907;
%LET TWO_MO_AGO = 201906;
%LET TWO_MO_AGO_APPS = JUN_APPS;
%LET TWO_MO_AGO_APPS_NEW = JUN_APPS_NEW;
%LET TWO_MO_BOOKED_2 = BOOKED_JUN;
%LET TWO_MO_UNBOOKED_2 = UNBOOKED_JUN;
%LET ONE_MO_BOOKED_2 = JUL_APPS_B_2;
%LET ONE_MO_UNBOOKED_2 = JUL_APPS_UNB_2;
%LET ALL_APPS_FILE_2 = ALL_APPS_JUL_FINAL;
%LET ONE_MO_AGO_APPS = JUL_APPS;
%LET ONE_MO_AGO_APPS_NEW = JUL_APPS_NEW;
%LET ONE_MO_AGO_APPS_2 = JUL_APPS_2;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_AUG2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_AUG2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_AUG2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
