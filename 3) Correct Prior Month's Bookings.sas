...
%LET NEW_MONTH_FILE_2 = APR_APPS_2;
/*
%LET APP_IMPORT_FILE = &ALL_APPS_2.; 
*/
%LET RECENT_MONTH_NO = 201904;
%LET ONE_MO_AGO = 201903;
%LET TWO_MO_AGO = 201902;
%LET TWO_MO_AGO_APPS = FEB_APPS;
%LET TWO_MO_AGO_APPS_NEW = FEB_APPS_NEW;
%LET TWO_MO_BOOKED_2 = BOOKED_FEB;
%LET TWO_MO_UNBOOKED_2 = UNBOOKED_FEB;
%LET ONE_MO_BOOKED_2 = MAR_APPS_B_2;
%LET ONE_MO_UNBOOKED_2 = MAR_APPS_UNB_2;
%LET ALL_APPS_FILE_2 = ALL_APPS_MAR_FINAL;
%LET ONE_MO_AGO_APPS = MAR_APPS;
%LET ONE_MO_AGO_APPS_NEW = MAR_APPS_NEW;
%LET ONE_MO_AGO_APPS_2 = MAR_APPS_2;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_APR2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_APR2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_APR2019.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
