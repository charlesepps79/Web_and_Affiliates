...
*/
%LET RECENT_MONTH_NO = 201808;
%LET ONE_MO_AGO = 201807;
%LET TWO_MO_AGO = 201806;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_AUG2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_AUG2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_AUG2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
