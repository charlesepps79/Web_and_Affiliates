...
*/
%LET RECENT_MONTH_NO = 201806;
%LET ONE_MO_AGO = 201805;
%LET TWO_MO_AGO = 201804;
%LET TWO_MO_AGO_APPS = APRIL_APPS;
%LET TWO_MO_AGO_APPS_NEW = APRIL_APPS_NEW;
%LET TWO_MO_BOOKED_2 = BOOKED_APRIL;
%LET TWO_MO_UNBOOKED_2 = UNBOOKED_APRIL;
...
PROC EXPORT 
	DATA = ALL_APPS_3 
	OUTFILE = "&MAIN_DIR\ALL_APPS_JUN2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYFINAL 
	OUTFILE = "&MAIN_DIR\CANOPY_FINAL_JUN2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
...
PROC EXPORT 
	DATA = CANOPYLOAD 
	OUTFILE="&MAIN_DIR\CANOPY_LOAD_JUN2018.xlsx" 
	DBMS = EXCEL 
	REPLACE;
RUN;
