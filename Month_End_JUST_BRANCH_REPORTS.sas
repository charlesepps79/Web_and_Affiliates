...
data _null_;
	call symput("importfile",
		"WORK.FINAL_SET_20211101_0001");
run;

PROC SQL;
   CREATE TABLE WORK.LEADS AS
   SELECT *
      FROM WORK.FINAL_SET_20211101_0001 t1;
QUIT;
...
PROC SQL;
	...
	SELECT t1.OWNBR,
       ...
       proc export
       	data = LT_BY_BRANCH
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\10_2021\October_2021_Web_Reports\Affiliates_by_Branch_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "Lending_Tree";
       run;
