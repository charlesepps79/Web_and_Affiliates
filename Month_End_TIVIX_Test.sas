...
data _null_;
	call symput("importfile",
		"WORK.final_set_20220301");
run;

PROC SQL;
   CREATE TABLE WORK.LEADS AS
   SELECT *
      FROM WORK.final_set_20220301 t1;
QUIT;
...
DATA LEADS_2;
	...
	x_branch_i_d2=put(x_branch_i_d, 10. -L);
	x_branch_i_d2=cats(repeat('0', 4-length(x_branch_i_d2)-1), x_branch_i_d2);
	drop x_branch_i_d;
	rename x_branch_i_d2=x_branch_i_d;

	if Branch in ('0301' '0160' '0309' '0118' '0126' '0308') and 
			leaddate > '11may2021'd and
			affiliate = 'DOT' or 
		state = 'SC' and 
			leaddate > '06jun2021'd and 
			affiliate = 'DOT' or
		state in ('NM' 'VA' 'WI') and 
			leaddate > '20jun2021'd and
			affiliate = 'DOT' or
		state in ('NC' 'MO' 'TN') and 
			leaddate > '26jul2021'd and
			affiliate = 'DOT' or
		state in ('AL' 'GA' 'OK') and 
			leaddate > '15aug2021'd and
			affiliate = 'DOT' or
		state in ('IL' 'TX') and 
			leaddate > '13sep2021'd and
			affiliate = 'DOT'
		then affiliate = 'API';
	TOTALAPPS = APP;
RUN;
...
DATA REPORTS_TABLE;
	...
	IF BOOKED = 1 AND AFFILIATE = 'CK' THEN DO;
		IF OriginalPrincipalBalance > 2500 THEN COSTPERLOAN = 200;
...
DATA REPORTS_TABLE;
	...
	IF RENEW_FLAG = 1 THEN renew_vol = OriginalPrincipalBalance;

	NEW_AMT = 0;

	IF RENEW_FLAG = 0 THEN NEW_AMT = OriginalPrincipalBalance;
	...
	IF IS_FUNDED = 1 THEN DO;
		...
		NETLOANAMT_CURRENT = OriginalPrincipalBalance;
	...
	IF IS_FUNDED = 1 AND ClassTranslation = 'Large' THEN DO;
		...
		LARGE_NETLOANAMT_CURRENT = OriginalPrincipalBalance;
	...
	IF IS_FUNDED = 1 AND
		...
		OriginalPrincipalBalance > 2500 THEN DO;
		LARGE_BOOKED_CURRENT = BOOKED;
		LARGE_NETLOANAMT_CURRENT = OriginalPrincipalBalance;
		LARGE_TOTALLOANCOST_CURRENT = TOTALLOANCOST;
		LARGE_TOTALLEADCOST_CURRENT = TOTALLEADCOST_CURRENT;
	...
	IF IS_FUNDED = 1 AND ClassTranslation = 'Small' THEN DO;
		...
		SMALL_NETLOANAMT_CURRENT = OriginalPrincipalBalance;
...
*** Generate ALL_BY_SOURCE_LEADSOURCE report --------------------- ***;
PROC SQL;
   CREATE TABLE ALL_BY_SOURCE_LEADSOURCE AS
   SELECT t1.AFFILIATE,
   		  t1.LEAD_SOURCE,
          /* Total Leads */
		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
...
*** Generate ALL_BY_UTMSOURCE_LEADSOURCE report ------------------ ***;
PROC SQL;
   CREATE TABLE ALL_BY_UTMSOURCE_LEADSOURCE AS
   SELECT t1.utm_source,
   		  t1.LEAD_SOURCE,
          /* Total Leads */
		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
        /* #PQ */
...
*** Generate ALL_BY_SRCD_CLASSTRANSLATION report ----------------- ***;
PROC SQL;
   CREATE TABLE ALL_BY_SRCD_CLASSTRANSLATION AS
   SELECT t1.SRCD,
   		  t1.CLASSTRANSLATION,
          /* Total Leads */
		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
...
PROC SQL;
	...
	SELECT t1.OWNBR,
        ...
        (AVG(t1.COSTPERLOAN)) FORMAT=DOLLAR8. AS 'CPL'n,
        	...
        	WHERE t1.AFFILIATE = 'EV'
        	GROUP BY t1.OWNBR;
        QUIT;

PROC SQL;
	CREATE TABLE BC_BY_BRANCH AS
	SELECT t1.OWNBR,
		/* Total Leads */
		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
        /* #PQ */
        ...
        (AVG(t1.COSTPERLOAN)) FORMAT=DOLLAR8. AS 'CPL'n,
                ...
                (((SUM(t1.TOTALLOANCOST_CURRENT)) +
        			...
        			FORMAT=DOLLAR8. AS CPK
        	FROM REPORTS_TABLE t1
        	WHERE t1.AFFILIATE = 'BC'
        	GROUP BY t1.OWNBR;
        QUIT;

PROC SQL;
	CREATE TABLE API_BY_BRANCH AS
	SELECT t1.OWNBR,
		/* Total Leads */
		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
        /* #PQ */
...
PROC SQL;
           CREATE TABLE EV_BY_STATE_AMT_BUCKET AS
           SELECT t1.LEAD_STATE,
                  t1.AMTBUCKET,
                  /* Total Leads */
        		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
...
PROC SQL;
           CREATE TABLE BC_BY_STATE_AMT_BUCKET AS
           SELECT t1.LEAD_STATE,
                  t1.AMTBUCKET,
                  /* Total Leads */
        		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
...
PROC SQL;
           CREATE TABLE API_BY_STATE_AMT_BUCKET AS
           SELECT t1.LEAD_STATE,
                  t1.AMTBUCKET,
                  /* Total Leads */
        		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
...
PROC SQL;
          CREATE TABLE EV_BY_APP_ADD_OWN AS
...
PROC SQL;
          CREATE TABLE BC_BY_APP_ADD_OWN AS
          SELECT t1.'Applicant Address Ownership'n,
                 /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
               /* #PQ */
...
PROC SQL;
          CREATE TABLE API_BY_APP_ADD_OWN AS
          SELECT t1.'Applicant Address Ownership'n,
                 /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
               /* #PQ */
...
PROC SQL;
          CREATE TABLE EV_BY_REQUEST_PURPOSE AS
...
PROC SQL;
          CREATE TABLE BC_BY_REQUEST_PURPOSE AS
          SELECT t1.'Loan Request Purpose'n,
                 /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
               /* #PQ */
...
PROC SQL;
          CREATE TABLE API_BY_REQUEST_PURPOSE AS
          SELECT t1.'Loan Request Purpose'n,
                 /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
               /* #PQ */
...
PROC SQL;
          CREATE TABLE EV_BY_AMT_BUCKET AS
          SELECT t1.AMTBUCKET,
                 /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
               /* #PQ */
...
PROC SQL;
          CREATE TABLE BC_BY_AMT_BUCKET AS
          SELECT t1.AMTBUCKET,
                 /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
               /* #PQ */
...
PROC SQL;
          CREATE TABLE API_BY_AMT_BUCKET AS
          SELECT t1.AMTBUCKET,
                 /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
               /* #PQ */
       ...
       *****************************************;
PROC SQL;
          CREATE TABLE EV_BY_DECISION_STATUS AS
...
PROC SQL;
          CREATE TABLE BC_BY_DECISION_STATUS AS
          SELECT t1.decision_status,
                 /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
               /* #PQ */
...
PROC SQL;
          CREATE TABLE API_BY_DECISION_STATUS AS
          SELECT t1.decision_status,
                 /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
               /* #PQ */
...
PROC SQL;
          CREATE TABLE EV_BY_SOURCE_STATE AS
          SELECT t1.AFFILIATE,
                 t1.LEAD_STATE,
                 /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
...
PROC SQL;
          CREATE TABLE BC_BY_SOURCE_STATE AS
          SELECT t1.AFFILIATE,
                 t1.LEAD_STATE,
                 /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
...
PROC SQL;
          CREATE TABLE API_BY_SOURCE_STATE AS
          SELECT t1.AFFILIATE,
                 t1.LEAD_STATE,
                 /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
...
PROC SQL;
          CREATE TABLE EV_BY_DISTRICT AS
          SELECT t1.District,
                /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
               /* #PQ */
...
PROC SQL;
          CREATE TABLE BC_BY_DISTRICT AS
          SELECT t1.District,
                /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
               /* #PQ */
...
PROC SQL;
          CREATE TABLE API_BY_DISTRICT AS
          SELECT t1.District,
                /* Total Leads */
       		(SUM(t1.TOTALLEADS_CURRENT)) AS 'Leads'n,
               /* #PQ */
...
PROC SQL;
          CREATE TABLE EV_AUTO_DC_BOOKED AS
          SELECT t1.*
             FROM WORK.REPORTS_TABLE t1
             WHERE t1.decision_status IN
                  ...
                  'Auto Declined',
                  'Declined'
                  ) AND t1.BOOKED_CURRENT = 1 AND t1.AFFILIATE = 'EV';
       QUIT;

PROC SQL;
          CREATE TABLE BC_AUTO_DC_BOOKED AS
          SELECT t1.*
             FROM WORK.REPORTS_TABLE t1
             WHERE t1.decision_status IN
                  (
                  'Auto Declined',
                  'Declined'
                  ) AND t1.BOOKED_CURRENT = 1 AND t1.AFFILIATE = 'BC';
       QUIT;

PROC SQL;
          CREATE TABLE API_AUTO_DC_BOOKED AS
          SELECT t1.*
             FROM WORK.REPORTS_TABLE t1
             WHERE t1.decision_status IN
                  (
                  'Auto Declined',
                  'Declined'
                  ) AND t1.BOOKED_CURRENT = 1 AND t1.AFFILIATE = 'API';
       QUIT;
       ...
       proc export
       	data = LT_BY_BRANCH
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\Affiliates_by_Branch_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "Lending_Tree";
       run;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\Lending_Tree_by_Routing_ID_and_Amount_Bucket_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "Lending_Tree";
       run;
       ...
       proc export
      	...
      	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\Affiliates_by_State_and_Amount_Bucket_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "Lending_Tree";
       run;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\Affiliates_by_Application_Address_Ownership_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "Lending_Tree";
       run;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\Affiliates_by_Request_Purpose_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "Lending_Tree";
       run;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\Affiliates_by_Amount_Bucket_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "LendingTree";
       run;
       ...
       proc export
       	data = ALL_BY_SOURCE
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\All_Affiliates_by_Source_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "All Sources";
       run;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\All_Affiliates_by_UTM_Campaign_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "UTM_Campaign";
       run;
       
       proc export
       	data = ALL_BY_SOURCE_LEADSOURCE
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\All_Affiliates_by_Lead_Source_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "Lead_Source";
       run;
       
       proc export
       	data = ALL_BY_UTMSOURCE_LEADSOURCE
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\All_Affiliates_by_UTM_Source_Lead_Source_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "UTM_Source_Lead_Source";
       run;
       
       proc export
       	data = ALL_BY_SRCD_CLASSTRANSLATION
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\All_Affiliates_by_SRCD_ClassTranslation_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "SRCD_ClassTranslation";
       run;
       
       proc export
       	data = LT_BY_SOURCE_STATE
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\Affiliates_by_Source_State_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "LendingTree";
       run;
       ...
       proc export
       	data = LT_BY_DISTRICT
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\Affiliates_by_District_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "LendingTree";
       run;
       ...
       proc export
       	...
       	outfile = "\\mktg-app01\E\cepps\Web_Report\Reports\02_2022\February_2022_Web_Reports\Affiliates_by_Decision_Status_&dt..xlsx"
       	dbms = xlsx replace;
       	sheet = "LendingTree";
       run;
